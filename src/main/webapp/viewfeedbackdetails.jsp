    ...
    <div class="row">
            ...
            <div class="user mt-5">
                ...
                <table class="table">
                   <c:forEach var="cus" items="${feedbackDetails}">
                    <c:set var="feedbackid" value="${cus.feedbackid}"/><!-- this line internally call to the get ID method in student class -->
                    <c:set var="name" value="${cus.name}"/>
                    <c:set var="email" value="${cus.email}"/>
                    
					<c:set var="phone" value="${cus.phone}"/>
					<c:set var="message" value="${cus.message}"/>
					<c:set var="rating" value="${cus.rating}"/>
                        <tr>
                            <td>Feedback ID</td>
                ...
                <br>
                <c:url value="feedbackupdate.jsp" var="updatefeedback"><!-- navigate to the updatestudent page and show these details -->
				<c:param name="feedbackid" value="${feedbackid}"/><!-- ID is the variable name of set tag above -->
        ...
        <div class="col-md-4">
            <div class="side-section mt-5">
                ...
                <a href="${updatefeedback}" class="btn btn-info btn-block">Edit Feedback</a>
                
    			<c:url value="Deletefeedbackservlet" var="feedbackdelete">
    			<c:param name="feedbackid" value="${feedbackid}"/>
				</c:url>

				<form action="${feedbackdelete}" method="post">
				    <input type="hidden" name="feedbackid" value="${feedbackid}"> <!-- Use hidden input to store the ID -->
				    <br>
