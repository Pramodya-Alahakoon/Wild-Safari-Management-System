...
.about-image, .mission-image, .team-member-image {
    max-width: 100%;
    height: auto;
    border-radius: 5px;
}
...
<nav class="navbar navbar-expand-lg navbar-light shadow">
    ...
    <main class="about-us">
        <section class="about-section">
            <h2>About Us</h2>
            <img src="images/910_232_kalawewa_480_380.jpg" alt="Safari Adventure" class="about-image">
            <p>Welcome to Wild Safari! We are passionate about bringing you the most thrilling and unforgettable wildlife experiences. Our mission is to provide our guests with an opportunity to connect with nature, explore breathtaking landscapes, and witness the wonders of wildlife in their natural habitat.</p>
            <p>Our expert guides are committed to ensuring that your safari experience is both safe and enjoyable. With years of experience and in-depth knowledge of the local ecosystem, they will take you on an adventure you will never forget. From breathtaking game drives to guided nature walks, we offer a variety of safari packages tailored to suit every adventurer's needs.</p>
        </section>
        
        <section class="mission-section">
            <h2>Our Mission</h2>
            <img src="images/910_114_yalaNP_480_380.jpg" alt="Mission" class="mission-image">
            <p>At Wild Safari, our mission is to promote conservation and sustainable tourism while providing our guests with authentic and immersive wildlife experiences. We believe in responsible travel that benefits local communities and protects the natural environment.</p>
        </section>
        
        <section class="team-section">
            <h2>Meet Our Team</h2>
            <div class="team-member">
                <img src="images/images.jfif" alt="John Doe" class="team-member-image">
                <h3>John Doe</h3>
                <p>Founder & Chief Guide</p>
                <p>With over 15 years of experience in wildlife tourism, John leads our team with passion and dedication.</p>
            </div>
            <div class="team-member">
                <img src="images/images.jfif" alt="Jane Smith" class="team-member-image">
                <h3>Jane Smith</h3>
                <p>Wildlife Expert</p>
                <p>Jane is our resident wildlife expert, ensuring every safari is educational and memorable.</p>
            </div>
