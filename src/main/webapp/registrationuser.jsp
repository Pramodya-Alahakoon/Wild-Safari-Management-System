...
<nav class="navbar navbar-expand-lg navbar-light shadow">
    ...
    <div class="container01">
        ...
        <form id="registration-form" action="insert" method="post">
            ...
            <button type="submit" name="sumbit" id="register-button" disabled>Register</button>
   ...
   <script>
    ...
    // Enable registration button if terms checkbox is checked
    termsCheckbox.addEventListener('change', () => {
        registerButton.disabled = !termsCheckbox.checked;
    });

    // Birthday validation (cannot select future date)
    dobInput.addEventListener('change', () => {
        const today = new Date();
        const selectedDate = new Date(dobInput.value);
        if (selectedDate > today) {
            dobInput.setCustomValidity('Birthday cannot be in the future');
